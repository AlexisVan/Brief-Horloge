...
var AIGUILLESEC = document.querySelector("#second"); //Extraire l'heure actuel à l'aide de l'objet new Date()

function demarrerLaMontre() {
  var date = new Date();
  console.log(date); //Stocker l'heure , minute , seconde  dans des varaiables
  // Avec ma variable qui contient la date + getHours() getMinutes() getSeconds()

  var heure = date.getHours();
  var minute = date.getMinutes();
  var secondes = date.getSeconds(); // Calculer de degré de mouvement de l'aiguille heure, de l'aiguille minute, de l'aiguille seconde
  ...
  AIGUILLEHR.style.transform = "rotate(" + heure * 360 / 12 + "deg)"; // AIGUILLEMIN.style.transform =`rotate(${minute * 360 /60 + secondes * 6/60}deg)`

  AIGUILLEMIN.style.transform = "rotate(" + minute * 360 / 60 + secondes * 6 / 60 + "deg)"; // AIGUILLESEC.style.transform = `rotate(${secondes * 360 / 60}deg)`
